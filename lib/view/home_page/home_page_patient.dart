...
class _PatientDashboardState extends State<PatientDashboard> {
  DatabaseReference dbRefHumAndTemp =
      FirebaseDatabase.instance.ref().child("(BOX)Hum&Temp");
  DatabaseReference dbRefBattery =
      FirebaseDatabase.instance.ref().child("battery");
  DatabaseReference dbRefBoxStatus =
      FirebaseDatabase.instance.ref().child("devices");
  DatabaseReference dbRefHealthMetrics =
      FirebaseDatabase.instance.ref().child("healthMonitor");
  DatabaseReference dbRefBodyTemperature =
      FirebaseDatabase.instance.ref().child("patientTemp");
  DatabaseReference dbCaregiverMessage =
      FirebaseDatabase.instance.ref().child("caregiverMessages");
  ...
  Widget build(BuildContext context) {
          ...
          children: [
            Container(
              ...
              margin: const EdgeInsets.only(
                  right: 30), // leave space for delete icon
    ...
    return Scaffold(
      floatingActionButton: authProvider.databaseUser!.patientOrCaregiver! ==
              "Cargiver"
                                  ...
                                  TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      suffixIcon: IconButton(
                                          onPressed: () async {
                                            Map<String, dynamic>
                                                caregiverMessagesMap = {
                                              'isUrgent': isMessageUrgent,
                                              'message':
                                                  caregiverMessageController
                                                      .text,
                                              'sender': authProvider
                                            ...
                                            try {
                                              await dbCaregiverMessage
                                                  .push()
                                                  .set(caregiverMessagesMap);
                                              caregiverMessageController
                                                  .clear();
                                              setState(() {});
                                            } catch (e) {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              authProvider.databaseUser!.patientOrCaregiver! == "Cargiver"
                  ? Padding(
                          ...
                          builder: (context, snapshot) {
                            if (snapshot.hasData &&
                              ...
                              dynamic temperatureC =
                                  data['temperatureC'] ?? 0.0;
                              dynamic temperatureF =
