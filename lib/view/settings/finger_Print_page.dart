          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                FutureBuilder<List<FingerPrintsData>>(
                  future: FingerprintDao.getFingerprintData(uid),
                  builder: (context, snapshot) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return ListTile(
                          leading:
                              Icon(Icons.fingerprint, color: Color(0xff4979FB)),
                          title: Text(
                            fingerprints[index].fingerprintName ??
                                "Fingerprint ${index + 1}",
                            style: GoogleFonts.getFont(
                          ...
                          child: ListTile(
                            onTap: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => AddNewFingerprint(),
                                  ));
                            },
                            leading: Icon(
                              Icons.fingerprint,
