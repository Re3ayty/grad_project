...
class PatientRole extends StatefulWidget {
  const PatientRole({super.key});

  @override
  State<PatientRole> createState() => _PatientRoleState();
}

class _PatientRoleState extends State<PatientRole> {
  ...
  void checkbox(value) {
    setState(() {
      allowCaregiverView = value ?? false;
    });
  }
